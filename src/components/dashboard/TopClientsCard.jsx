...
export default function TopClientsCard({ clients = [] }) {
    ...
    return (
        <Card className="h-full">
            <h3 className="text-[10px] font-black text-gray-400 dark:text-zinc-500 uppercase tracking-[0.2em] mb-6">Mejores Clientes</h3>
            <div className="space-y-5">
                {validClients.map((client, idx) => {
                    ...
                    return (
                        <div key={idx} className="group cursor-default">
                            <div className="flex items-center justify-between gap-3 mb-2">
                                <div className="flex items-center gap-3 min-w-0 flex-1">
                                    ...
                                    <div className="min-w-0">
                                        <p className="font-black text-gray-900 dark:text-zinc-100 text-sm tracking-tight leading-snug group-hover:text-blue-600 transition-colors uppercase truncate">{client.nombre || "Cliente"}</p>
                                        <p className="text-[10px] font-bold text-gray-400 dark:text-zinc-500 uppercase tracking-widest">{client.cantidad_pedidos || 0} compras</p>
                                    </div>
                                </div>
                            ...
                            <div className="w-full h-1.5 bg-gray-50 dark:bg-zinc-800/50 rounded-full overflow-hidden">
                                <div
                ...
                {validClients.length === 0 && (
                    <div className="py-10 flex flex-col items-center justify-center text-gray-400 dark:text-zinc-500 bg-gray-50 dark:bg-zinc-800/50 rounded-2xl border border-dashed border-gray-200 dark:border-white/10">
