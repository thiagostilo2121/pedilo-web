    ...
    return (
        <DashboardLayout>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pb-20 space-y-10">
                ...
                <PageHeader
                    title="Toppings"
                    subtitle="Gestioná los grupos de extras (salsas, agregados, sabores) para tus productos."
                    badge="Adicionales"
                    borderBottom
                    actions={
                        <PrimaryButton onClick={() => openModal()} icon={Plus} iconRotate>
                            Crear Grupo
                        </PrimaryButton>
                    }
                />
                ...
                {loading ? (
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-sm border border-dashed border-gray-200 dark:border-white/10 p-12 text-center flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">
                        <div className="w-20 h-20 bg-orange-50 text-orange-500 rounded-full flex items-center justify-center mb-6">
                            <Layers size={40} />
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-zinc-100 mb-2">No tienes grupos de toppings</h3>
                        <p className="text-gray-400 dark:text-zinc-500 max-w-sm mx-auto mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {grupos.map((grupo) => (
                            <div
                                key={grupo.id}
                                className="group bg-white dark:bg-zinc-900 rounded-3xl border border-gray-100 dark:border-white/10 p-6 hover:shadow-xl hover:shadow-gray-200 dark:shadow-black/20/50 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden"
                            >
                                <div className="absolute top-0 right-0 p-4 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity flex gap-2 z-10">
                                    <button
                                        ...
                                        className="p-2 bg-white dark:bg-zinc-900 text-gray-600 dark:text-zinc-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg shadow-sm border border-gray-100 dark:border-white/10 transition-colors"
                                        title="Editar"
                                    >
                                        <Pencil size={16} />
                                    </button>
                                    <button
                                        ...
                                        className="p-2 bg-white dark:bg-zinc-900 text-gray-600 dark:text-zinc-400 hover:text-red-600 hover:bg-red-50 rounded-lg shadow-sm border border-gray-100 dark:border-white/10 transition-colors"
                                        title="Eliminar"
                                    >
                                        <Trash2 size={16} />
                                    </button>
                                ...
                                <div className="flex flex-col h-full">
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-gray-900 dark:text-zinc-100 text-lg leading-tight">{grupo.nombre}</h3>
                                    ...
                                    <div className="space-y-3 flex-1">
                                        {(grupo.toppings || []).slice(0, 4).map((t, i) => (
                                            <div key={i} className="flex justify-between items-center text-sm p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 dark:bg-zinc-800/50 dark:hover:bg-white/5 dark:bg-white/5 transition-colors border border-transparent hover:border-gray-100 dark:border-white/10">
                                                <div className="flex items-center gap-2 truncate">
                                                    <div className={`w-2 h-2 rounded-full shrink-0 ${t.disponible !== false ? 'bg-green-400' : 'bg-red-400'}`} />
                                                    <span className={`font-medium text-gray-700 dark:text-zinc-300 truncate ${t.disponible === false ? "opacity-50 line-through" : ""}`}>
                                                        {t.nombre}
                                                    </span>
                                                </div>
                                                <span className="font-bold text-gray-900 dark:text-zinc-100 shrink-0 ml-2">
                                    ...
                                    {(grupo.toppings?.length || 0) > 4 && (
                                        <div className="mt-4 pt-3 border-t border-gray-100 dark:border-white/10 text-center">
                                            <p className="text-xs font-bold text-gray-400 dark:text-zinc-500">+{grupo.toppings.length - 4} opciones más</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                ...
                <ModalShell
                    ...
                    subtitle="Configurá las opciones disponibles"
                    size="xl"
                    footer={
                        <div className="flex flex-col-reverse sm:flex-row gap-4">
                            <button
                                onClick={() => setShowModal(false)}
                                className="flex-1 px-6 py-3.5 rounded-xl border border-gray-200 dark:border-white/10 text-gray-700 dark:text-zinc-300 font-bold hover:bg-gray-100 dark:hover:bg-white/10 transition-all active:scale-95 text-center"
                            >
                                Cancelar
                            </button>
                            <button
                ...
                >
                    ...
                    <div className="p-5 sm:p-8 overflow-y-auto custom-scrollbar space-y-8 flex-1">
                        ...
                        <div className="space-y-1.5 ">
                            <label className="text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-widest ml-1">Nombre del Grupo</label>
                            <input
                                type="text"
                                value={form.nombre}
                                onChange={(e) => setForm({ ...form, nombre: e.target.value })}
                                className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border-gray-100 dark:border-white/10 rounded-xl focus:bg-white dark:focus:bg-zinc-800 dark:bg-zinc-900 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all font-bold text-gray-900 dark:text-zinc-100 placeholder:text-gray-400 dark:text-zinc-500 text-lg"
                        ...
                        <div className="bg-gray-50 dark:bg-white/5 rounded-2xl p-6 border border-gray-100 dark:border-white/10">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-sm font-bold text-gray-800 dark:text-zinc-200">Agregar Opción</h3>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <div className="flex-1 space-y-1">
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all text-sm font-medium"
                                        placeholder="Nombre (Ej. Cheddar)"
                                    />
                                </div>
                                <div className="w-full sm:w-32 space-y-1 relative">
                                    <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-zinc-500 font-bold text-sm">$</div>
                                    <input
                                        type="number"
                                        value={nuevoTopping.precio}
                                        onChange={(e) => setNuevoTopping({ ...nuevoTopping, precio: e.target.value })}
                                        onKeyDown={(e) => e.key === 'Enter' && addTopping(e)}
                                        className="w-full pl-7 pr-4 py-2.5 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all text-sm font-medium"
                                        placeholder="0"
                                    />
                                </div>
                                <button
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3 px-1">
                                <h3 className="text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-widest">Opciones ({form.toppings.length})</h3>
                            </div>

                            {form.toppings.length === 0 ? (
                                <div className="text-center py-8 text-gray-400 dark:text-zinc-500 border-2 border-dashed border-gray-100 dark:border-white/10 rounded-2xl bg-gray-50/50">
                                    <p className="text-sm font-medium">Aún no agregaste opciones a este grupo.</p>
                                </div>
                            ) : (
                                <div className="space-y-2 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                                    {form.toppings.map((t, i) => (
                                        <div key={i} className="group flex items-center gap-3 p-3 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/10 rounded-xl hover:border-orange-200 transition-colors shadow-sm">

                                            {/* Checkbox Stock */}
                                            <label className="cursor-pointer relative flex items-center justify-center w-8 h-8 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 dark:bg-white/5 dark:hover:bg-white/10 dark:bg-white/5 transition-colors" title={t.disponible ? "En Stock" : "Sin Stock"}>
                                                <input
                                                    type="checkbox"
                                            ...
                                            {editingToppingIndex === i ? (
                                                ...
                                                <div className="flex-1 flex flex-col sm:flex-row gap-2 animate-in fade-in duration-200">
                                                    <input
                                                        ...
                                                        className="flex-1 px-3 py-1.5 bg-gray-50 dark:bg-white/5 border border-orange-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-orange-500"
                                                        autoFocus
                                                    />
                                                    <div className="flex gap-2">
                                                        <input
                                                            ...
                                                            className="w-20 px-3 py-1.5 bg-gray-50 dark:bg-white/5 border border-orange-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-orange-500"
                                                        />
                                                        <button
                                                ...
                                                <>
                                                    <div className="flex-1 min-w-0">
                                                        <p className={`font-medium text-gray-900 dark:text-zinc-100 truncate ${t.disponible === false ? "opacity-50 line-through" : ""}`}>
                                                            {t.nombre}
                                                        </p>
                                                    </div>
                                                    <div className="font-bold text-gray-900 dark:text-zinc-100 bg-gray-50 dark:bg-white/5 px-2.5 py-1 rounded-lg text-sm shrink-0">
                                                        {(t.precio > 0) ? `+$${t.precio}` : 'Gratis'}
                                                    </div>
                                                    <div className="flex items-center gap-1 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity">
                                                        <button
                                                            onClick={() => setEditingToppingIndex(i)}
                                                            className="p-1.5 text-gray-400 dark:text-zinc-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                                                            title="Editar"
                                                        >
                                                            <Pencil size={16} />
                                                        </button>
                                                        <button
                                                            ...
                                                            className="p-1.5 text-gray-400 dark:text-zinc-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors"
                                                            title="Eliminar"
                                                        >
                                                            <X size={16} />
                                                        </button>
